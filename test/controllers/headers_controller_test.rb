...
class HeadersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create header" do
    assert_difference('Header.count') do
      post headers_url, params: { header: { creator: @header.creator, image: @header.image, manufacturer: @header.manufacturer, name: @header.name, partnum: @header.partnum, platform: @header.platform } }
    end
  ...
  test "should update header" do
    patch header_url(@header), params: { header: { creator: @header.creator, image: @header.image, manufacturer: @header.manufacturer, name: @header.name, partnum: @header.partnum, platform: @header.platform } }
